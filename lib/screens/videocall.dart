              ...
              //full pic user
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: FittedBox(
                        fit: BoxFit.fill,child: Image.asset('images/user.png')),
                  ),
                ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        child: Image.asset('images/vuesax-linear-microphone-2.png')
                                    ),
                                    ...
                                    Container(
                                        ...
                                        child: Image.asset('images/Call.png',color:Colors.white,)
                                    ),
                                    SizedBox(width: MediaQuery.of(context).size.width*0.05,),
                                    ...
                                    Container(
                                        ...
                                        child: Image.asset('images/vuesax-linear-video-slash.png')
                                    ),
                                  ],
                                ),
                              )
